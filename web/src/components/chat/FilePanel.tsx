...
function TextEditor({
  ...
  return createPortal(
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/70 flex-shrink-0">
        ...
        <div className="flex-1 p-3 overflow-hidden">
          {loading ? (
            ...
            <Textarea
              ...
              className="w-full h-full font-mono text-sm text-foreground resize-none bg-muted/70"
              spellCheck={false}
            />
          )}
        </div>
...
export function FilePanel({ groupJid, onClose }: FilePanelProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-card">
      ...
      {/* Breadcrumb */}
      <div className="border-b border-sidebar-border bg-background px-4 py-2">
