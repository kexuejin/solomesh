...
export interface WebDeps {
  ...
  reloadGlobalIMConfig?: (channel: ImChannel, config: unknown) => Promise<boolean>;
  reloadUserIMConfig?: (userId: string, channel: ImChannel) => Promise<boolean>;
  getImChannelStatus?: () => Record<ImChannel, boolean>;
  getUserImChannelStatus?: (userId: string) => Record<ImChannel, boolean>;
